...
class layout
{
    ...
    // Dashboard shell (sidebar + topbar) to provide a consistent wireframe across pages
        ...
        <div class="app">
            <aside class="sidebar">
                ...
                <nav class="sidebar-nav">
                    <a class="nav-item <?php echo $active==='dashboard'?'active':''; ?>" href="hospital_dashboard.php">
                        <span class="icon">⌁</span>
                        <span>Dashboard</span>
                    </a>
                    <a class="nav-item" href="blood_requests.php?action=create">
                        <span class="icon">＋</span>
                        <span>Create Request</span>
                    </a>
                    <a class="nav-item" href="blood_requests.php?filter=active">
                        <span class="icon">●</span>
                        <span>Active Requests</span>
                        <span class="badge" id="activeBadge" style="display:none"></span>
                    </a>
                    <a class="nav-item <?php echo $active==='history'?'active':''; ?>" href="history.php">
                        <span class="icon">⟲</span>
                        <span>History</span>
                    </a>
                    <a class="nav-item <?php echo $active==='inventory'?'active':''; ?>" href="inventory.php">
                        <span class="icon">⬒</span>
                        <span>Inventory</span>
                    </a>
    ...
    public function donorDashboardStart($conf, $active = '')
    {
        ...
        <div class="app">
            <aside class="sidebar">
                ...
                <nav class="sidebar-nav">
                    <a class="nav-item <?php echo $active==='dashboard'?'active':''; ?>" href="donor_dashboard.php">
                        <span class="icon">⌁</span>
                        <span>Dashboard</span>
                    </a>
                    <a class="nav-item <?php echo $active==='requests'?'active':''; ?>" href="blood_requests.php">
                        <span class="icon">❤</span>
                        <span>Requests</span>
                        <span class="badge" id="donorRequestsBadge" style="display:none"></span>
                    </a>
                    <a class="nav-item <?php echo $active==='history'?'active':''; ?>" href="donation_history.php">
                        <span class="icon">⟲</span>
                        <span>History</span>
                    </a>
                    <a class="nav-item <?php echo $active==='profile'?'active':''; ?>" href="profile.php">
                        <span class="icon">👤</span>
                        <span>Profile</span>
                    </a>
                    <a class="nav-item" href="logout.php">
            ...
            <main class="main">
                <header class="topbar">
                    ...
                    <div class="topbar-actions">
                        <button class="icon-btn" aria-label="notifications">🔔<span class="dot" id="notifDot" style="display:none"></span></button>
                        <div class="avatar" title="Account"></div>
                    </div>
                </header>
                <section class="content">
